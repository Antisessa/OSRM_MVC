...
public class osrmController {
    ...
    public String getRoute(@RequestParam("keyPoints")String coords,
        ...
        /*
            example request to OSRM server, keyPoints вида E(долгота lng), N(широта lat)
            localhost/osrm/route?keyPoints=52.167286,55.625559;52.181051,55.62404&response=view
        */
    ...
    public String getView(@RequestParam("keyPoints")String coords,
                           Model model) throws JsonProcessingException {
        /*
            example request to OSRM server, keyPoints вида E(долгота lng), N(широта lat)
            localhost/osrm/route?keyPoints=52.167286,55.625559;52.181051,55.62404&response=view
        */
        ...
        return PolylineUtils.toStringForGeoJSON(decodedGeometry);
    }
}
